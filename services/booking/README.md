...
Owns the **booking** bounded context and its PostgreSQL schema/database. It never reads another service's tables.
...
Database: `arcade_booking`. Migrations in `migrations/` create only this service's tables. 
