...
Owns the **inventory** bounded context and its PostgreSQL schema/database. It never reads another service's tables.
...
Database: `arcade_inventory`. Migrations in `migrations/` create only this service's tables. 
