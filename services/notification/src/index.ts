...
const app = createHttpApp({ dbReady: () => db.ready(), dependencyReady: () => dependencyReady, routes: notificationRoutes(db) });
const server = createServer(app);
server.listen(env.PORT, () => console.log('notification listening on', env.PORT));
